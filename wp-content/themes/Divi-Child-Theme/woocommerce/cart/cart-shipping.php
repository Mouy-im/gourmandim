			...
			<ul id="shipping_method" class="woocommerce-shipping-methods">
				<?php foreach ( $available_methods as $method ) : ?>
					<li>
						...
						//add calendar
						if ('local_pickup:2' === $method->id ) {
							echo '<div id="pickup_date">Choissisez votre jour et heure de retrait :<br> <input type="text" id="date_picker" class="datetimepicker form-control" name="date_pickup" placeholder="AAAA/mm/jj - HH:mm"></div>';
						}?>
						<script>
